...
{
    //Класс для работы с допустимыми рамками вводимых значений параметров расчёта конфигураций без
    //строгого соответствия стандарту ISO/IEC 11801. Инкапсулирован в DiapasonLocator.

    /// <summary>
    /// Класс для работы с допустимыми рамками вводимых значений параметров расчёта конфигураций без строгого соответствия стандарту ISO/IEC 11801.
    /// </summary>
